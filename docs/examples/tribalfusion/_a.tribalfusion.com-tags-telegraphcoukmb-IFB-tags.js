...
if (e9Manager === undefined || e9Manager.init === false)
	...
	e9Manager = manager;
        ...
        var e9Page = 
	 {
	   ...
	   host: "a.tribalfusion.com",
  	   busterframe: (e9 && e9.busterframe) || "http://www.telegraph.co.uk/adops/tribalfusion/tfBuster_telegraph.html",
  	   busterDomain: "",
	   site: "telegraphcoukmb",
	   adSpace: "ifb",
	   tagKey: "3179728435",
	   ...
	   tagOptions: {"snackBar":{"serveSnackBar":false}},
		...
		var e9Ad = 
		 {
		   ...
		   setAdReqParams:    
			...
			cpx(t,'adParams','bidderparams', adSpec.bidderparams);
		      },
...
else
 {
   if (e9 !== undefined) 
    {
      e9Manager.setSite("telegraphcoukmb","ifb");
